...
if(APPLE)
    if(STORM_MESA_NINE)
        message(WARNING "STORM_MESA_NINE is ignored on macOS; native D3D9 compatibility layers are disabled")
    endif()

    message(STATUS "Native D3D9 compatibility layers are disabled on macOS")
